import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-WBKQ4HGQ.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-DVOYKHN3.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await import("./dagre-VKFMJZFB-J3U64VHY.js"), "loader")
    },
    {
      name: "swimlane",
      loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-5IMT3BWC-D5BPWFDT.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-JH36ORCC-6WNAFIQL.js"), "loader")
      }
    ] : []
  ]);
